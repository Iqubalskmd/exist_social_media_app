...
import { Custombutton, TextInput, TopBar } from '../components';
...
function Home() {
  ...
  const [suggestedFriends,setSuggesedfriends]=useState(suggest);
              ...
              {friendRequest?.map(({_id,requestFrom:from})=>(
                <div key={_id} className='flex items-center justify-between'>
                  ...
                  <div className='flex gap-1 '>
                    ...
                    <Custombutton
                    title='deny'
                    containerStyles='border-[#666] text-xs text-ascent-1 px-1.5 py-1 rounded-full
                    '
                    />
